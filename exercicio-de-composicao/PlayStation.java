...
public class PlayStation {
	...
	public void setVersao(String versao) {		
		...
		if(versao == "1") {
			System.out.println("PlayStation 1 meu chapa meio antigo n�o acha?");
		} else if(versao == "2") {
			...
			System.out.println("PlayStation 4 oloco vei tu tem um console de ultima gera��o que foda vei");
		} else if(versao == "5") {
